...
Expected output: `agents.output/critic/4-provider-limits-native-critique.md`

ROUTING must include `context_file: agents.output/critic/4-provider-limits-native-critique.md`.
