...
UAT scope: verify post-G9 rejection was addressed: mobile Quality page must show one chart/card per row. Screenshot evidence exists at `dashboard/.playwright/4-dashboard-parity-quality-mobile-g9-fix2.png`. Route to G9 user preview if ready.
