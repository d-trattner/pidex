...
test('accepts each finite Plan049 lifecycle pointer state and rejects custom runner routes', () => {
  ...
  const states = [
    ...
    '> Plan051 completed at `d3b4196eb1dc874b9c4e1085c0d6ef8b0a6c2efc`: Linux passed 76/76; native Windows passed 75, failed 0, skipped one explicit POSIX-only test.',
    '> Plan049 remains terminal rejected history. Standalone Plan050/051 foundation passed same-SHA Linux/native-Windows evidence at `d3b4196eb1dc874b9c4e1085c0d6ef8b0a6c2efc`; no merge authority.',
  ];
