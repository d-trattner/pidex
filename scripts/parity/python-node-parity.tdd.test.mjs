...
function stable(value) {
  ...
  if (value && typeof value === 'object') {
    ...
    for (const [k, v] of Object.entries(value).sort()) {
      if (['timestamp', 'generated_at', 'created_at', 'updated_at', 'last_hygiene_at', 'installed_at', 'uninstalled_at', 'operator_decisions', 'operator_decisions_by_type', 'operator_decisions_by_reason', 'valid_skips', 'expectation_corrections'].includes(k)) continue;
