...
export const CONTRACTS = {
  ...
  OpQualityReview: { contract_id: 'operator.OpQualityReview.terminal-pdq', required_when: 'terminal pipeline event exists', allowed_decision_types: ['skip_step', 'manual_evidence', 'backfill_evidence'], allowed_skip_reasons: ['auto-pdq-disabled', 'optional-hooks-disabled', 'terminal-event-backfill', 'report-logic-regeneration-pending'], resolution_options: ['run an explicit manual PDQ review', 'record valid OpDecision skip/manual evidence', 'backfill OpQualityReview', 'correct expectation contract'] },
