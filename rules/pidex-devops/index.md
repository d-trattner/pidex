...
| npm + GitHub Release Workflow | [npm-github-release-workflow.md](npm-github-release-workflow.md) | PROC-NPM-GH-RELEASE | Public npm package releases require release commit, public-readiness, pushed annotated tag, npm verification, GitHub Release object, and closure proof |
