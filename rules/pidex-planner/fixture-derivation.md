...
1. **Grep existing domain fixture / seed files** in the project before authoring fixture data:
   ...
   - Project-specific grep command and file paths: `agents.wiki.<project>/rules/pidex-planner.md`
...
If the active project has `agents.wiki.<project>/rules/pidex-planner.md`, load it for:
