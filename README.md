...
The original five-fixture benchmark selected Hybrid as the general default. Initiative 038 then added all-role C1 screening and independent H2 holdouts: Balanced now uses Sol medium for Critic, Sol high for Designer and QA, and Sol high instead of xhigh for Security. Lowcost preserves those critical routes but uses Terra medium for Code Reviewer and QA, where repeated H2 runs showed large token reductions with correct core outcomes. Neither prepared profile uses Spark. See [Provider limits and profiles](readme/provider-limits-and-profiles.md), the [final routing table](wiki/completed/038-gpt56-balanced-and-spark-profile-evaluation/final-routing-table-2026-07-22.md), and the [Lowcost table](wiki/completed/038-gpt56-balanced-and-spark-profile-evaluation/lowcost-routing-candidate-2026-07-22.md).
