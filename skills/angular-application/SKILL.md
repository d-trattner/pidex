...
The official base and conditional profiles are available now. Test-derived PIDEX edge cases are a separate evidence layer. Load the evidence-backed edge-case file when the task contains asynchronous work whose completions can arrive out of order.
